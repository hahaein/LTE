...
#include "epc/gtp/GtpUserSimplified4.h"
...
Define_Module(GtpUserSimplified4);

void GtpUserSimplified4::initialize(int stage)
{
    ...
    pgwAddress_ = pgwbinder_->assignPgwAddress();

    ownerType_ = selectOwnerType(getAncestorPar("nodeType"));
}

EpcNodeType GtpUserSimplified4::selectOwnerType(const char * type)
{
...
void GtpUserSimplified4::handleMessage(cMessage *msg)
{
...
void GtpUserSimplified4::handleFromTrafficFlowFilter(IPv4Datagram * datagram)
{
...
void GtpUserSimplified4::handleFromUdp(GtpUserMsg * gtpMsg)
{
