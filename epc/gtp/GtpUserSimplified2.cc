...
#include "epc/gtp/GtpUserSimplified2.h"
#include "inet/networklayer/contract/ipv4/IPv4ControlInfo.h"
#include "inet/networklayer/common/L3AddressResolver.h"
#include <iostream>

Define_Module(GtpUserSimplified2);

void GtpUserSimplified2::initialize(int stage)
{
    ...
    pgwAddress_ = L3AddressResolver().resolve("pgw2");

    ownerType_ = selectOwnerType(getAncestorPar("nodeType"));
}

EpcNodeType GtpUserSimplified2::selectOwnerType(const char * type)
{
...
void GtpUserSimplified2::handleMessage(cMessage *msg)
{
...
void GtpUserSimplified2::handleFromTrafficFlowFilter(IPv4Datagram * datagram)
{
...
void GtpUserSimplified2::handleFromUdp(GtpUserMsg * gtpMsg)
{
