...
#include "epc/gtp/GtpUserSimplified_modified.h"
#include "inet/networklayer/contract/ipv4/IPv4ControlInfo.h"
#include "inet/networklayer/common/L3AddressResolver.h"
#include <iostream>

Define_Module(GtpUserSimplified_modified);

void GtpUserSimplified_modified::initialize(int stage)
{
...
EpcNodeType GtpUserSimplified_modified::selectOwnerType(const char * type)
{
...
void GtpUserSimplified_modified::handleMessage(cMessage *msg)
{
...
void GtpUserSimplified_modified::handleFromTrafficFlowFilter(IPv4Datagram * datagram)
{
...
void GtpUserSimplified_modified::handleFromUdp(GtpUserMsg * gtpMsg)
{
