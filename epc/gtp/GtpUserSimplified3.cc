...
#include "epc/gtp/GtpUserSimplified3.h"
...
Define_Module(GtpUserSimplified3);

void GtpUserSimplified3::initialize(int stage)
{
    ...
    pgwAddress_ = pgwbinder_->getPgwAddress();

    ownerType_ = selectOwnerType(getAncestorPar("nodeType"));
}

EpcNodeType GtpUserSimplified3::selectOwnerType(const char * type)
{
...
void GtpUserSimplified3::handleMessage(cMessage *msg)
{
...
void GtpUserSimplified3::handleFromTrafficFlowFilter(IPv4Datagram * datagram)
{
...
void GtpUserSimplified3::handleFromUdp(GtpUserMsg * gtpMsg)
{
