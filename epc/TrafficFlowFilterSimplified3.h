...
#ifndef _LTE_TRAFFICFLOWFILTERSIMPLIFIED3_H_
#define _LTE_TRAFFICFLOWFILTERSIMPLIFIED3_H_
 ...
 */
class TrafficFlowFilterSimplified3 : public cSimpleModule
{
  ...
  protected:
    ...
    int checkingUE(L3Address srcAddress);
